...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/mrtg.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by AzRoY | Bbm: yu-suf | @e-Server | pr34k3r</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/vps.conf"
...
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.conf "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/iptables.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/1194-client.conf"
...
cd
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/badvpn-udpgw"
...
#cache ram
cd
wget https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/clearcache/clearcache.sh
mv clearcache.sh /root/
chmod 755 /root/clearcache.sh

# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/conf/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/update_dropbear/dropbear-2018.76.tar.bz2
...
# bannerssh
wget https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/menu/bannersshlink.sh
...
wget -O speedtest.py "https://raw.githubusercontent.com/azroy369/vpsdebianbyazroy/master/menu/speedtest.py"
...
echo ""  | tee -a log-install.txt
echo "SILAHKAN REBOOT VPS ANDA UNTUK MENJALANKAN VPN  !"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "==============================================="  | tee -a log-install.txt
